    ...
    <footer className="border-t bg-card">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div>
            <h3 className="mb-4 font-headline font-semibold">Pour les Acheteurs</h3>
          ...
          <div>
            <h3 className="mb-4 font-headline font-semibold">Pour les Organisateurs</h3>
            <ul className="space-y-2 text-sm">
              <li>
              ...
              <li>
                <Link href="/dashboard/events/create" className="text-muted-foreground hover:text-primary">
                  Créer un événement
                </Link>
              </li>
              <li>
          ...
          <div>
            <h3 className="mb-4 font-headline font-semibold">Suivez-nous</h3>
