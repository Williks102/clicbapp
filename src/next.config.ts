...
const cspHeader = `
    ...
    connect-src 'self' https://*.paiementpro.net https://paiementpro.net https://www.paiementpro.net vitals.vercel-insights.com *.googleapis.com https://apis.google.com https://*.cloudworkstations.dev wss: https://clicbillet.com https://www.clicbillet.com https://mpayment.orange-money.com https://monticket.online https://*.monticket.online https://vercel.live;
    worker-src 'self' blob:;
    frame-src 'self' https://*.paiementpro.net https://paiementpro.net https://www.paiementpro.net https://clicbillet.com https://www.clicbillet.com https://mpayment.orange-money.com https://monticket.online https://*.monticket.online https://vercel.live https://studio-6644592922-93aa3.firebaseapp.com;
    object-src 'none';
    base-uri 'self';
