...
const cspHeader = `
    default-src 'self';
    script-src 'self' 'unsafe-eval' 'unsafe-inline' https://*.paiementpro.net;
    ...
    connect-src 'self' https://*.paiementpro.net vitals.vercel-insights.com *.googleapis.com;
    worker-src 'self' blob:;
    frame-src 'self' https://*.paiementpro.net;
    object-src 'none';
    base-uri 'self';
    form-action 'self';
    frame-ancestors *;
